    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <hr class="my-4">
                <p class="mb-5">Quer saber mais sobre nosso sitio?<br/> Entre em contato com nosso numero ou email</p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-4 mr-auto text-center">
                ...
                <p>
                    <a href="sitiodonamarta@outlook.com">sitiodonamarta@outlook.com</a>
                </p>
            </div>
        </div>
    </div>
